...
public class FfmpegService {
    ...
    public byte[] extractFrameBytes(String path, int index) throws InterruptedException, IOException {
        if (!isFfmpegPresent) throw new FileNotFoundException("Ffmpeg not present!");
    ...
    public Video.VideoMetadata getVideoInfo(String path) throws IOException, InterruptedException {
