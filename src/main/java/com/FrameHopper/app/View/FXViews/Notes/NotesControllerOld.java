...
@Component
@Scope("prototype")
public class NotesControllerOld implements LanguageChangeListener {
    @FXML
    ...
    public NotesControllerOld(NotesService noteService, OpenViewsInformationContainer viewContainer) {
